...
(library Library_1
	...
	(compDef "MMBD1503A" (originalName "MMBD1503A") (compHeader (numPins 3) (numParts 1) (refDesPrefix D)
		...
		(compPin "3" (pinName "ANODE / CATHODE") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.onsemi.com/pub/Collateral/MMBD1501-D.pdf")
		(attr "Height" "1.2 mm")
	)
