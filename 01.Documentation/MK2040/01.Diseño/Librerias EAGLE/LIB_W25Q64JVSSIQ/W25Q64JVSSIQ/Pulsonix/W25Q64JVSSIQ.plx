...
//765379/847691/2.49/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "W25Q64JVSSIQ" (originalName "W25Q64JVSSIQ")
	...
	(compDef "W25Q64JVSSIQ" (originalName "W25Q64JVSSIQ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "W25Q64JVSSIQ"))
		...
		(attr "Manufacturer_Part_Number" "W25Q64JVSSIQ")
		(attr "Mouser Part Number" "454-W25Q64JVSSIQ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Winbond/W25Q64JVSSIQ?qs=qSfuJ%252Bfl%2Fd4DecxlHDmB8w%3D%3D")
		(attr "Arrow Part Number" "W25Q64JVSSIQ")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/w25q64jvssiq/winbond-electronics?region=nac")
		(attr "Description" "64M-bit Serial Flash Memory with uniform 4KB sectors and Dual/Quad SPI")
		(attr "<Hyperlink>" "https://www.winbond.com/hq/search-resource-file.jsp?partNo=W25Q64JVSSIQ&type=datasheet")
		(attr "<Component Height>" "2.16")
		(attr "<STEP Filename>" "W25Q64JVSSIQ.stp")
