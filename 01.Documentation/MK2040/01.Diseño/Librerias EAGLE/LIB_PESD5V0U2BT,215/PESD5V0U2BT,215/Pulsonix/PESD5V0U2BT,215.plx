...
(library Library_1
	...
	(symbolDef "PESD5V0U2BT_215" (originalName "PESD5V0U2BT_215")
	...
	(compDef "PESD5V0U2BT,215" (originalName "PESD5V0U2BT,215") (compHeader (numPins 3) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PESD5V0U2BT_215"))
		...
		(attr "Manufacturer_Part_Number" "PESD5V0U2BT,215")
		(attr "Mouser Part Number" "771-PESD5V0U2BTT/R")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Nexperia/PESD5V0U2BT215?qs=LOCUfHb8d9uKnndgcTorSw%3D%3D")
		(attr "Arrow Part Number" "PESD5V0U2BT,215")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/pesd5v0u2bt215/nexperia?region=nac")
		(attr "Description" "PESD5V0U2BT - Ultra low capacitance bidirectional double ESD protection diode")
		(attr "<Hyperlink>" "https://assets.nexperia.com/documents/data-sheet/PESD5V0U2BT.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "PESD5V0U2BT,215.stp")
